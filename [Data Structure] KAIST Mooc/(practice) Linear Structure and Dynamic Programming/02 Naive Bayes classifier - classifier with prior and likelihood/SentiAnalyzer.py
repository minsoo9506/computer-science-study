...
class SentiAnalyzer:
    ...
    def calculateProbWord(self, idxWord):
        ...
        positiveProb = int(positive+1) / float(sum(self.dataReviewTraining))
        negativeProb = int(negative+1) / float(sum(self.dataReviewTraining))
    ...
    def calculateProbReview(self):
        ...
        return positiveProb, negativeProb # prior probability
