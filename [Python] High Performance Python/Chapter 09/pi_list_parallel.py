...
if __name__ == "__main__":
    ...
    parser.add_argument('--nbr_workers', type=int, default = 4, help='Number of workers e.g. 1, 2, 4, 8')
    parser.add_argument('--nbr_samples_in_total', type=int, default=1e8, help='Number of samples in total e.g. 100000000')
    parser.add_argument('--processes', action="store_true", default=True, help='True if using Processes, absent (False) for Threads')
